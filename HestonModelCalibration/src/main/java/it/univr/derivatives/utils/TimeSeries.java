...
public class TimeSeries {
    ...
    public void plot(String title, DoubleUnaryOperator function2) throws Exception {
        if (data.isEmpty()) {
            System.out.println("TimeSeries is empty — nothing to plot.");
            return;
        }
        ...
        // Use the modern PlotableFunction2D constructor
        Plot2D plot = new Plot2D(xMin, xMax, size(), new DoubleUnaryOperator[]{interpolatedFunction, function2});
