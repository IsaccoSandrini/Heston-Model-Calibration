...
public class LookbackPutFixedStrike extends AbstractAssetMonteCarloProduct {
	...
	public LookbackPutFixedStrike(double maturity, double strike, int numberOfTimeSteps) {
		this.maturity = maturity;
		this.strike = strike;
		this.underlyingIndex = 0;
	...
	public LookbackPutFixedStrike(int underlyingIndex, double maturity, double strike, int numberOfTimeSteps) {
		this.maturity = maturity;
		this.strike = strike;
		this.underlyingIndex = underlyingIndex;
		this.numberOfTimeStepsDiscretized = numberOfTimeSteps;
	...
	public RandomVariable getValue(double evaluationTime, AssetModelMonteCarloSimulationModel model)
		...
		RandomVariable values = minimum.mult(-1.0).add(strike).floor(0.0);
